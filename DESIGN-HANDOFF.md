# c7717f3a-8e08-489c-a749-e9ea3f3a2030 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `anti-stress-neomorph-app-final.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `anti-stress-neomorph-app-final.html`
...
- A single self-contained `anti-stress-neomorph-app-final.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `anti-stress-neomorph-app-final.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `anti-stress-neomorph-app-final.html`
- `anti-stress-neomorph-app-full.html`
- `anti-stress-neomorph-app-with-night-mode.html`
