...
SITE_TEXT.de = {
  ...
  landing: { title: 'Digital Fidget: Mental ASMR - Drücken. Hören. Reset.', eyebrow: 'Ein kleines taktiles Ritual', h1: 'Drücken.<br>Hören.<br>Reset.', lead: 'Ein ruhiger Wellness-Button für überreizte Momente. Spüre sanftes haptisches Feedback, höre einen befriedigenden Klick und mach eine kurze Fokuspause.', store: 'Bald im', features: [['Taktil gestaltet', 'Reaktiver Sound und native Haptik machen jeden Druck bewusst und geerdet.'], ['Der Kern ist kostenlos', 'Classic Click sowie Classic und Night bleiben verfügbar. Premium schaltet weitere Themes, Sounds und Skins frei.'], ['Privat und fokussiert', 'Keine Werbung, kein Konto und keine Verhaltensanalyse in der App.']] },
  pages: {
...
SITE_TEXT.es = {
  ...
  landing: { title: 'Digital Fidget: Mental ASMR - Pulsa. Escucha. Respira.', eyebrow: 'Un pequeño ritual táctil', h1: 'Pulsa.<br>Escucha.<br>Respira.', lead: 'Un botón de bienestar tranquilo para momentos de saturación. Siente una respuesta háptica suave, escucha un clic satisfactorio y toma una pausa breve.', store: 'Próximamente en', features: [['Diseñado para el tacto', 'El sonido reactivo y la háptica nativa hacen que cada pulsación se sienta clara.'], ['Lo esencial es gratis', 'Classic Click y los temas Classic y Night siempre están disponibles. Premium desbloquea más temas, sonidos y skins.'], ['Privado y enfocado', 'Sin anuncios, sin cuenta obligatoria y sin analítica de comportamiento.']] },
  pages: {
...
SITE_TEXT.pt = {
  ...
  landing: { title: 'Digital Fidget: Mental ASMR - Pressione. Ouça. Respire.', eyebrow: 'Um pequeno ritual tátil', h1: 'Pressione.<br>Ouça.<br>Respire.', lead: 'Um botão de bem-estar discreto para momentos sobrecarregados. Sinta um háptico suave, ouça um clique satisfatório e faça uma pausa curta.', store: 'Em breve na', features: [['Tátil por design', 'Som responsivo e haptics nativos tornam cada toque claro e intencional.'], ['O essencial é grátis', 'Classic Click e os temas Classic e Night estão sempre disponíveis. Premium libera mais temas, sons e skins.'], ['Privado e focado', 'Sem anúncios, sem conta obrigatória e sem análise comportamental.']] },
  pages: {
